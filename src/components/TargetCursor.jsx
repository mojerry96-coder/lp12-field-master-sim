...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      // If the locked target is removed from the DOM while the cursor is on it,
      // no mouseleave ever fires and the brackets stay stranded on a dead rect.
      // This happens in normal use here: buttons like "Add n78 antenna" unmount
      // the moment they are clicked. Release the lock when the node goes away.
